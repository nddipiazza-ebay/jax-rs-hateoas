...
public abstract class HateoasResponse extends Response {
     ...
     * @param status the response status
     * @return a new ResponseBuilder
     * @throws IllegalArgumentException if status is less than 100 or greater than 599.
     */
     ...
     *
     * @param tag the string content of a strong entity tag. The JAX-RS runtime
     ...
     *
     * @param location the redirection URI. If a relative URI is supplied it will be
    ...
    public static abstract class HateoasResponseBuilder extends ResponseBuilder {
         ...
         * @return this
         */
        public abstract HateoasResponseBuilder selfLink(FieldPath fieldPath, String id,
                                                        String... entityFields);
...
//
         ...
         * making sure that the links will be applied at each end node.
         *
         * Note that the order in witch the {@link ParamExpander}ers are defined determines
         ...
         * @see ParamExpander
         */
        public abstract HateoasResponseBuilder link(FieldPath fieldPath, String id, String rel, ParamExpander... paramExpanders); //T
         ...
         * @see ParamExpander
         */
        public abstract HateoasResponseBuilder selfLink(FieldPath fieldPath, String id, ParamExpander... paramExpanders);
         ...
         * @see ParamExpander
         */
        public abstract HateoasResponseBuilder link(String id, String rel, ParamExpander... paramExpanders);            //T
         ...
         * @see ParamExpander
         */
        public abstract HateoasResponseBuilder selfLink(String id, ParamExpander... paramExpanders);

        /**
         * Append a link to be included for each element nested in the entity, building the URI using the specified
         * expanders (expects a Collection).
         *
         * Note that the order in witch the {@link ParamExpander}ers are defined determines
         * their position in the compiled path.
         *
         ...
         * @see ParamExpander
         */
        public abstract HateoasResponseBuilder each(String id, String rel, ParamExpander... paramExpanders);            //T

        /**
         * Append a link to be included for each element nested in the entity, building the URI using the specified
         * expanders, defaulting the rel to 'self'. (expects a Collection).
         *
         * Note that the order in witch the {@link ParamExpander}ers are defined determines
         * their position in the compiled path.
         *
         ...
         * @see ParamExpander
         */
        public abstract HateoasResponseBuilder selfEach(String id, ParamExpander... paramExpanders);                    //T
//
// ---------------------------------------------------
//
        ...
        public static HateoasLink makeLink(String id, String rel, Object... params) {
            HateoasContext hateoasContext = HateoasContextProvider.getDefaultContext();
        ...
        public static HateoasLink makeLink(String id, String rel, Map<String, Object> queryParameters, Object... params) {
            HateoasContext hateoasContext = HateoasContextProvider.getDefaultContext();

            LinkableInfo linkableInfo = hateoasContext.getLinkableInfo(id);
            return DefaultHateoasLink.fromLinkableInfo(linkableInfo, rel, queryParameters, params);
        }
         ...
         *
         * @param variants a list of available representation variants, a null value
         ...
         *
         * @param language the language of the response entity, if null any existing
         ...
         *
         * @param location the content location. Relative or absolute URIs may be
         ...
         *
         * @param tag the entity tag, if null any existing entity tag value will
         *            be removed.
         * @return the updated ResponseBuilder
         */
         ...
         *
         * @param lastModified the last modified date, if null any existing last modified
         ...
         *
         * @param cacheControl the cache control directives, if null removes any existing
         ...
         *
         * @param expires the expiration date, if null removes any existing expires
         *                value.
         * @return the updated ResponseBuilder
         */
         ...
         *
         * @param cookies new cookies that will accompany the response. A null value
